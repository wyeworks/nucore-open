...
Rails.application.configure do
  config.after_initialize do
    ...
    # School specific
    Bullet.add_safelist type: :n_plus_one_query, class_name: "Item", association: :facility_account
    Bullet.add_safelist type: :n_plus_one_query, class_name: "SplitAccounts::Split", association: :subaccount
    Bullet.add_safelist type: :n_plus_one_query, class_name: "UmassCorum::SubsidyAccount", association: :owner
    Bullet.add_safelist type: :n_plus_one_query, class_name: "UmassCorum::SubsidyAccount", association: :owner_user

    Bullet.add_safelist type: :unused_eager_loading, class_name: "UmassCorum::SpeedTypeAccount", association: :owner
    Bullet.add_safelist type: :unused_eager_loading, class_name: "UmassCorum::SpeedTypeAccount", association: :owner_user
    Bullet.add_safelist type: :unused_eager_loading, class_name: "UmassCorum::SpeedTypeAccount", association: :user
    Bullet.add_safelist type: :unused_eager_loading, class_name: "UmassCorum::SubsidyAccount", association: :owner
    Bullet.add_safelist type: :unused_eager_loading, class_name: "UmassCorum::SubsidyAccount", association: :owner_user
    Bullet.add_safelist type: :unused_eager_loading, class_name: "UmassCorum::VoucherSplitAccount", association: :owner
    Bullet.add_safelist type: :unused_eager_loading, class_name: "UmassCorum::VoucherSplitAccount", association: :owner_user
  end
