...
Rails.application.configure do
  config.after_initialize do
    ...
    Bullet.add_safelist type: :unused_eager_loading, class_name: "PriceGroup", association: :parent_price_group
    ...
    Bullet.add_safelist type: :unused_eager_loading, class_name: "Statement", association: :closed_events
    Bullet.add_safelist type: :unused_eager_loading, class_name: "Statement", association: :order_details
