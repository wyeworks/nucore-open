...
RSpec.describe Reports::GeneralReportsController do
  ...
  context "report searching" do
    before :each do
      ...
      @order_detail_ordered_yesterday_unfulfilled.update!(ordered_at: 1.day.ago)

      @order_detail_ordered_yesterday_fulfilled_today_unreconciled = place_and_complete_item_order(@user, @authable, @account)
      @order_detail_ordered_yesterday_fulfilled_today_unreconciled.update!(ordered_at: 1.day.ago)
      ...
      @order_detail_ordered_today_fulfilled_next_month_unreconciled.update(fulfilled_at: 1.month.from_now)

      @order_detail_ordered_yesterday_fulfilled_yesterday_reconciled_today = place_and_complete_item_order(@user, @authable, @account)
      @order_detail_ordered_yesterday_fulfilled_yesterday_reconciled_today.update!(ordered_at: 1.day.ago, fulfilled_at: 1.day.ago)
      ...
      @order_detail_ordered_yesterday_fulfilled_yesterday_reconciled_yesterday.update(ordered_at: 1.day.ago, fulfilled_at: 1.day.ago)
