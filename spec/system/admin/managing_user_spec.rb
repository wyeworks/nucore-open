...
RSpec.describe "Managing User Details", :aggregate_failures, feature_setting: { "users_authentication.create_users" => true, "pricing.user_based_price_groups" => true, reload_routes: true } do
