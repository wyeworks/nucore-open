...
module OrderDetail::Accessorized
  ...
  included do
    belongs_to :product_accessory, optional: true

    belongs_to :parent_order_detail, class_name: "OrderDetail", inverse_of: :child_order_details, optional: true
  ...
  module ClassMethods
    ...
    def ordered_by_parents
      order(Arel.sql("COALESCE(order_details.parent_order_detail_id, order_details.id)"))
