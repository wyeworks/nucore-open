  ...
  class ExportRaw
    ...
    def default_report_hash # rubocop:disable Metrics/AbcSize
      hash = {
        ...
        actual_start_time: ->(od) { od.time_data.presence&.actual_start_at },
        actual_end_time: ->(od) { od.time_data.presence&.actual_end_at },
        actual_minutes: ->(od) { od.time_data.presence&.actual_duration_mins },
