...
namespace :demo do
  ...
  task seed: :environment do
    ...
    unless user_senior_staff
      ...
      user_senior_staff.password = "P@ssw0rd!!"
    ...
    unless user_facility_administrator
      ...
      user_facility_administrator.password = "P@ssw0rd!!"
    ...
    unless user_director
      ...
      user_director.password = "P@ssw0rd!!"
      user_director.save
    ...
    unless user_account_manager
      ...
      user_account_manager.password = "P@ssw0rd!!"
    ...
    if SettingsHelper.feature_on?(:global_billing_administrator)
      ...
      if user_global_billing_administrator.blank?
        ...
        user_global_billing_administrator.password = "P@ssw0rd!!"
    ...
    unless user_facility_billing_administrator
      ...
      user_facility_billing_administrator.password = "P@ssw0rd!!"
