...
RSpec.describe UmassCorum::JournalWriter do
  it "writes the headers" do
    header_row = described_class.new(
      headers: {
        ...
        batch_trans_amount: BigDecimal.new("14392.58"),
  ...
  it "writes a row" do
    ...
    expect(journal.rows.first).to eq("   155308753080LM19111    06172019Carter, Kenneth     00000006750DALS095            UMAMH       Light Micro         PSE      53106A090700034B03       S12100000001075")
  end
  ...
  it "writes multiple rows" do
    ...
    expect(journal.rows.drop(1).first).to eq("   155226699900LM19111    06172019Carter, Kenneth     00000006750CALS095            UMAMH       Light Micro         PSE      51511A606363000D06                      ")
  end
end
